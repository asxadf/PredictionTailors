...
%     R_H_Req_Dis  = OVar_Phi_R_H.*Load_Net_SUM_Dis_ACT;
%     R_C_Req_Dis  = OVar_Phi_R_C.*Load_Net_SUM_Dis_ACT;
    R_H_Req_Dis  = OVar_Phi_R_H.*(Load_Gro_SUM_Dis_ACT - RES_Pre_SUM);
    R_C_Req_Dis  = OVar_Phi_R_C.*(Load_Gro_SUM_Dis_ACT - RES_Pre_SUM);
end
%
%% ------------------------------ Decision ----------------------------- %%
