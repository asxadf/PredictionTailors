function[Recorder_Updated, Flag_Out_Converge] = NCCG_SP_v7(Season, Recorder_Text, Recorder_Old)
Num_Hour = 24;
Num_RES  = 5;
Iter_Max = 10;
%
for i = 1:Iter_Max
    %% SP
    if i == 1
        [Recorder_Updated, Flag_In_Converge] = NCCG_Sub_SP_v7(Season, Recorder_Text, Recorder_Old);
    else
        [Recorder_Updated, Flag_In_Converge] = NCCG_Sub_SP_v7(Season, Recorder_Text, Recorder_Updated);
    end
    ...
    %% MP
    [Recorder_Updated, Flag_In_Converge] = NCCG_Sub_MP_v7(Season, Recorder_Text, Recorder_Updated);
    In_Obj_Gap_Latest = Recorder_Updated{29, end}(end);
