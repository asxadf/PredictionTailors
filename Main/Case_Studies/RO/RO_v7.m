...
for i = 1:Iteration_Max
    % MP
    if i == 1
        [Recorder_Updated, Flag_Out_Converge] = NCCG_MP_v7(Season, Recorder_Text, Recorder_Ini);
    else
        [Recorder_Updated, Flag_Out_Converge] = NCCG_MP_v7(Season, Recorder_Text, Recorder_Updated);
    end
    ...
    % SP
    [Recorder_Updated, Flag_Out_Converge] = NCCG_SP_v7(Season, Recorder_Text, Recorder_Updated);
    % Check Out Convergence
    if Flag_Out_Converge == 1
        disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
        Out_Obj_Gap = Recorder_Updated{9, end};
...
if Budget < 10
    save(strcat('S', num2str(Season), '_0', num2str(Budget)));
elseif Budget >= 10
    save(strcat('S', num2str(Season), '_', num2str(Budget)));
end