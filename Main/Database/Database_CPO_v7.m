%% -------------------------------- RES -------------------------------- %%
% RES #01 Bus #70   [0, 2144]  Scaled Capacity: 200MW OFFSHORE
% RES #02 Bus #49   [0, 0205]  Scaled Capacity: 200MW Flanders Elia
% RES #03 Bus #100  [0, 0789]  Scaled Capacity: 200MW Flanders DSO
% RES #04 Bus #59   [0, 0144]  Scaled Capacity: 200MW Wallonia Elia
% RES #05 Bus #92   [0, 0669]  Scaled Capacity: 200MW Wallonia DSO
%
%
%% ---------------------------- RES_Farm_DAF --------------------------- %%
%  Column  #1         ... #5
...
%  Column  #5        #6        #7         #8
%  Data    SU_price  SD_price  R_H_Price  R_C_Price   
%
%% ------------------------------- Branch ------------------------------ %%
%  Column  #1    #2    #3         #4          
