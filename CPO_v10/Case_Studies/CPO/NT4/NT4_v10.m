...
NH     = 7;
Period = 28;
lambda = 1000000; % Large lambda is quick
M_P = 100000;
M_D = 5000000;
% Default
Update_Freq   = 7;
...
Path_Case = strcat(Path_Root, Link, 'Case_Studies', Link, 'CPO', Link, Case);
%% ---------------------------- Initialize ----------------------------- %%
...
%
%% ------------------------- Find TRA scenario ------------------------- %%
[Day_Tra_All, Date_Tra_All] = Find_Latest_v10(NH, Link, Path_Data);
%
%% ------------------------------ Training ----------------------------- %%
for Update = 1:Num_Update
    ...
    for Iteration = 1:Iteration_Max
        ...
        [Enu_I{Update}(:, Iteration),...
         ...
         = CPO_Step01_SP_Auto_v10(Day_Update_List(Update),...
         ...
         [OVar_Phi_RES{Update}{end+1},...
          ...
          = CPO_Step02_MP_Auto_v10(Day_Update_List(Update),...
                                    Date_Update_List(Update),...
                                    NT,...
                                    NH,...
                                    lambda,...
