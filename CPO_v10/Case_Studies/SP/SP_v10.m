...
if Num_Scen < 10
    save(strcat(Path_SO, Link, 'Season_', num2str(Season), '_Scen_00', num2str(Num_Scen)));
end

if Num_Scen >= 10 && Num_Scen < 100
    save(strcat(Path_SO, Link, 'Season_', num2str(Season), '_Scen_0', num2str(Num_Scen)));
end

if Num_Scen >= 100
    save(strcat(Path_SO, Link, 'Season_', num2str(Season), '_Scen_', num2str(Num_Scen)));
end