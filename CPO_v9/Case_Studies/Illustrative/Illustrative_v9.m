...
Case    = 'Illustrative';
UC_Mode = 'C';
Date_Dispatch = '17-Dec-2020';
Cost_SYS_ACT_PPO = 1.919501290999978e+05;
Error = [0.7:0.0025:1.3]' - 1;
...
OVar_Phi_R_H = 0.25*ones(24, 1);
OVar_Phi_R_C = 0.25*ones(24, 1);
...
save(strcat(Path_Case, Link, Date_Dispatch, '_', num2str(size(Cost_Loss,1)), '.mat'));