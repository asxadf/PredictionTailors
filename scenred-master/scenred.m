...
% Build a scenario tree reducing N observed samplings from a multivariate distribution.
% The algorithm is described in
% "Nicole Growe-Kuska, Holger Heitsch and Werner Romisch
%  - Scenario Reduction Scenario Tree Construction for Power Management Problems".
% Inputs: 
...
%                  statistically dependent (sampled from historical data or from a copula)
%
%        metric:   {'euclidean','cityblock'}, used for Kantorovich-Rubinstein metric
%
...
%
% Outputs:
%         S: T*n_obs*n matrix, containing all the path in the scenario tree
%         
%         P: T*n_obs matrix, containing evolviong probabilities for each scenario
%          
%         J: T*n_obs matrix, indicating non-zero entries of P (if a scenario is present at a given timestep)
%          
%        Me: T*n_scen*n_scen matrix, containing which scenario is linked with which at time t
%         
